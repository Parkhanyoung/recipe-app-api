...
class PublicUserTest(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'phanyoung@naver.com', 'password': 'password123',
                   'name': 'name'}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        ...
        payload = {'email': 'phanyoung@naver.com', 'password': 'pw',
                   'name': 'name'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='phanyoung@naver.com', password='password123')
        payload = {'email': 'phanyoung@naver.com', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_no_user(self):
        """Test that a token is not created when the user doesn't exist"""
        payload = {'email': 'phanyoung@naver.com', 'password': 'password123'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_missing_field(self):
        ...
        payload = {'email': 'phanyoung@naver.com', 'password': ''}
        res = self.client.post(TOKEN_URL, payload)
        self.assertNotIn('token', res.data)
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
...
class PrivateUserTest(TestCase):
    ...
    def test_update_user_profile(self):
        ...
        payload = {'password': 'changedpassword', 'name': 'changedname'}
